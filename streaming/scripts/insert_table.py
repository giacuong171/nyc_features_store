...
def main():
    ...
    kafka_df = pd.read_parquet("/home/jacky/Documents/DE/nyc_features_store/airflow/data/stream/stream.parquet")
    # drop na
    ...
    for _ in range(NUM_ROWS):
        ...
        placeholders = ",".join(["%s"] * len(data))  # Create placeholders for each value
